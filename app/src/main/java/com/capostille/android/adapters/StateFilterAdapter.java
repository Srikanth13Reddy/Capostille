...
public class StateFilterAdapter extends RecyclerView.Adapter<StateFilterAdapter.MyHolder>
{
    public static ArrayList<StateModel> arrayList;
    Context context;

    public StateFilterAdapter(ArrayList<StateModel> arrayList, Context context) {
    ...
    {
        StateModel obj= arrayList.get(position);
        holder.cb_status.setChecked(obj.getSelected());
        holder.tv_name.setText(arrayList.get(position).getStateName());
